...
- AI 分析是商业转化核心入口，必须在首屏概览中常驻；AI 分析历史在概览展示。
- PC 端 Tab 固定为：概览、走势、技术、基本面、持仓 & 提醒。（2026-08-15：「新闻与公告」Tab 已下线；新闻接口保留，仅供 AI 分析上下文调用。）
- 移动端主入口固定为：概览、走势、分析、持仓；「分析」组内二级切换技术、基本面。
