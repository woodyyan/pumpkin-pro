  ...
  return (
    ...
    >
      <div className="rounded-[24px] border border-primary/20 bg-[radial-gradient(circle_at_top_left,_rgba(230,126,34,0.16),_transparent_34%),linear-gradient(135deg,rgba(255,255,255,0.05),rgba(255,255,255,0.02))] px-5 py-4">
        <div className="flex items-center justify-between gap-5">
          <div className="min-w-0 flex-1">
            ...
            <div className="mt-3 truncate text-[26px] font-bold leading-tight text-foreground">{stockName}</div>
            <div className="mt-1 text-sm font-medium tracking-[0.16em] text-foreground-dim">{stockCode}</div>
          </div>
      ...
      <AIAnalysisReportContent
        ...
        className="mt-5 rounded-[28px] border-border bg-card/95"
        logicExpanded
      ...
      <div className="mt-5 rounded-[24px] border border-border bg-[var(--color-bg-hover)] px-5 py-4">
        <div className="flex items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <img src="/logo.png" alt="卧龙" width="40" height="40" className="rounded-xl border border-border bg-[var(--color-bg-hover)] p-1" />
            <div>
              <div className="text-base font-semibold text-foreground">卧龙AI量化交易台</div>
            </div>
          </div>
          <div className="text-right">
            <div className="text-xs uppercase tracking-[0.28em] text-foreground-dim">Website</div>
            <div className="mt-1 text-sm font-semibold text-foreground-muted">wolongtrader.top</div>
          </div>
        </div>
      </div>
    </div>
