export const AI_REPORT_PRICING_PLANS = [
  ...
  },
  {
    ...
    highlights: ['10 份标准 PDF 报告', '可定制投资周期：短线 / 波段 / 长线', '支持结合用户持仓情况分析', '支持自定义分析问题'],
  ...
  },
  {
    ...
    highlights: ['50 份标准 PDF 报告', '包含投资版全部服务', '优先生成，免排队', '多股票对比分析', '新功能优先体验'],
