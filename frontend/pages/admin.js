      ...
      <header className="sticky top-0 z-50 border-b border-border bg-background/90 backdrop-blur-md">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-3">
          ...
          <div className="flex items-center gap-4 text-sm">
            ...
            <span className="text-foreground-muted">{adminEmail}</span>
            <button
              type="button"
              onClick={logout}
              className="rounded-lg border border-[var(--color-border-strong)] px-3 py-1 text-sm text-foreground-muted transition hover:border-[var(--color-border-strong)] hover:text-foreground"
            >
              退出
            </button>
          </div>
      ...
      <main className="mx-auto max-w-7xl px-6 py-8 space-y-8">
        ...
        {loading && !stats ? (
          ...
          <>
            ...
            {/* Panel 4: Live */}
            <section>
              <h2 className="text-base font-semibold text-foreground-muted mb-3">📈 行情看板</h2>
