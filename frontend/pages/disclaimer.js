    ...
    <>
      ...
      <div className="max-w-3xl mx-auto pb-16 space-y-8">
        ...
        <div className="prose dark:prose-invert prose-sm max-w-none space-y-6 text-foreground-muted leading-7">
          ...
          <h2 className="text-lg font-semibold text-foreground">3. 数据准确性免责</h2>
          ...
          <h2 className="text-lg font-semibold text-foreground">4. 信号推送免责</h2>
