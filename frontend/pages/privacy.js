    ...
    <>
      ...
      <div className="max-w-3xl mx-auto pb-16 space-y-8">
        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-6 text-foreground-muted leading-7">
          ...
          <h3 className="text-base font-medium text-foreground/90">1.1 您主动提供的信息</h3>
          ...
          <h3 className="text-base font-medium text-foreground/90">1.2 自动收集的信息</h3>
          <ul className="list-disc pl-5 space-y-1">
            <li><strong>访问日志</strong>：IP 地址、浏览器类型、访问时间，用于安全防护与故障排查。</li>
            <li><strong>操作记录</strong>：登录/登出时间、信号触发记录、Webhook 投递记录，用于审计与问题追溯。</li>
          </ul>

          <h3 className="text-base font-medium text-foreground/90">1.3 我们不收集的信息</h3>
          <ul className="list-disc pl-5 space-y-1">
          ...
          <h2 className="text-lg font-semibold text-foreground">2. 信息的使用</h2>
          <p>我们仅在以下场景使用您的信息：</p>
          ...
          <h2 className="text-lg font-semibold text-foreground">3. 信息的存储与安全</h2>
          <ul className="list-disc pl-5 space-y-1">
          ...
          <h2 className="text-lg font-semibold text-foreground">4. 信息的共享</h2>
          ...
          <h2 className="text-lg font-semibold text-foreground">6. 未成年人保护</h2>
          <p>本平台面向具有完全民事行为能力的成年人。如果我们发现未成年人未经监护人同意注册使用本平台，将主动删除相关信息。</p>

          <h2 className="text-lg font-semibold text-foreground">7. 政策更新</h2>
        ...
        <div className="pt-6 border-t border-border flex gap-4 text-sm text-foreground-dim">
