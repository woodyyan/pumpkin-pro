    ...
    <>
      ...
      <div className="max-w-3xl mx-auto pb-16 space-y-8">
        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-6 text-foreground-muted leading-7">
          ...
          <h3 className="text-base font-medium text-foreground/90">1.1 本平台提供的服务</h3>
          ...
          <h3 className="text-base font-medium text-foreground/90">1.2 本平台不提供的服务</h3>
          <ul className="list-disc pl-5 space-y-1">
          ...
          <h2 className="text-lg font-semibold text-foreground">2. 账户注册与安全</h2>
          ...
          <h2 className="text-lg font-semibold text-foreground">4. 数据来源与准确性</h2>
          ...
          <h2 className="text-lg font-semibold text-foreground">6. 服务变更与中断</h2>
          <p>6.1 我们可能因系统维护、升级或不可抗力等原因暂时中断服务，将尽量提前通知。</p>
          <p>6.2 我们保留修改、暂停或终止部分或全部服务的权利。对于免费服务的终止，我们不承担赔偿责任。</p>

          <h2 className="text-lg font-semibold text-foreground">7. 协议的变更</h2>
          <p>我们有权根据需要修订本协议。修订后的协议将在本平台公布，重大变更将通过站内通知告知您。如您在变更后继续使用本平台，则视为同意修订后的协议。</p>

          <h2 className="text-lg font-semibold text-foreground">8. 适用法律与争议解决</h2>
